...
public class InboxDollars {

	WebDriver driver;
	WebDriverWait wait;

	@Test(priority = 1)
	public void LoginInboxDollars() {
		driver = Util.LaunchChromeBrowser();

		driver.get("https://www.inboxdollars.com/");
		...
		driver.findElement(By.xpath("//input[@id='pwd']")).sendKeys("Inbox@1234");

		driver.findElement(By.xpath("//input[@value='Login']")).click();

		System.out.println("Logged into Inbox dollors");
	}
